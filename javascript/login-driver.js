...
document.querySelector('.login').addEventListener("click",function(){
    document.querySelector('.popup-driver').style.display="flex";
});
document.querySelector('.close').addEventListener("click", function () {
    document.querySelector(".popup-driver").style.display = "none";
});

document.querySelector('.btn-logindriver').addEventListener("click",function startTimer(){
    ...
    document.querySelector('.timer').style.display = "flex";
    document.querySelector('.btn-logindriver').innerHTML = "ارسال مجدد کد فعالسازی";
});
